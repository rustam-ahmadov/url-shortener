...
type LoginRequest struct {
	...
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"`         //Pass of the user to login.
...
type IsAdminResponse struct {
	...
	IsAdmin bool `protobuf:"varint,1,opt,name=is_admin,json=isAdmin,proto3" json:"is_admin,omitempty"` //Indicate whether the user id an admin.
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x5a, 0x13, 0x72, 0x75, 0x73, 0x74, 0x61, 0x6d, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31, 0x3b,
